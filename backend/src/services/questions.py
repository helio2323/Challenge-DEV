...
def get_all_questions():
    ...
    questions = transform_objects_to_json(questions, id="id", title="title", subtitle="subtitle", type_question="type_question", question="question", id_language="id_language", xp_reward="xp_reward", response="response", created_at="created_at", dificulty="dificulty")
